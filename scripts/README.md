...
One-off experiment scripts, infrastructure, and debug tools. Ordered by purpose. Scripts tagged (Legacy — fine-tuning era, provenance) live in `legacy_finetuning/`.
