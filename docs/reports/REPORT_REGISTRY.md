...
| docs/analyses/tabpfn_vs_gbdt_baselines_finetuning.md | tabpfn-vs-gbdt-baselines-finetuning | technical | active | scripts/run_tabarena_insurance_benchmark.py; scripts/prepare_insurance_datasets.py; scripts/eval/insurance_benchmark_v1/results_per_split.csv | scripts/eval/insurance_benchmark_v1/results_per_split.csv; scripts/eval/insurance_benchmark_v1/method_info.csv; outputs/current/tables/domain_finetune_study_runs.csv; outputs/current/logs/domain_finetune_logbook.md; outputs/current/tables/tabpfn_finetune_trial_results.csv; data/raw/bemtl97.csv | 2026-08-01 |
